...
if grep -q "/home/joe/ai/data/ollama_workbench/sessions" /tmp/status_normal.out; then
...
if grep -q "/home/joe/ai/test_data/ollama_workbench/sessions" /tmp/status_test.out; then
